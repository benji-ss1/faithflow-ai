...
highlights:
  ...
  - Pick any folder on this computer and PresentFlow mirrors it. Put a new background in that folder from your desktop, press Sync now, and it is in your media — no importing file by file.
  - Press Sync now in the Media bar to check the folder. Files that are new get added; files you removed from the folder drop out of the list.
