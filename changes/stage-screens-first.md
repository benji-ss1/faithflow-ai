...
The editor also now says "on stage now" when you are editing the layout a
screen is currently showing, tells you when a timer box points at a timer that
was deleted, and says so when you reach the limit of items on one layout
