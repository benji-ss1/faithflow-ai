...
highlights:
  ...
  - Desktop app, new "Pro audio driver (beta)" switch. When on, PresentFlow reads every input channel of your interface, including over ASIO on Windows, and shows the real channel count so you can pick the pastor's mic channel.
