...
export const GENERATED_CHANGELOG: ChangelogEntry[] = [
  {
    ...
    "highlights": [
      ...
      "Your text size now stays large on the screen instead of resetting. At the very top of both sliders it settles at the largest size we can safely send to every screen, rather than snapping back to normal.",
