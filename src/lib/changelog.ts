...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "Over your camera now has a Layout choice: Lower third (a see-through band over your camera — the default when you first set up the OBS editor) or Full projector (the words across the whole camera picture, as before). In Lower third you can put the band Upper, Mid, Lower or a Custom position, and set its background, height, text size, see-through and text colour.",
