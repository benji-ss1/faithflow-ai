...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "Over your camera now has a Layout choice: Lower third (a see-through band over your camera — the default for new links) or Full projector (the words across the whole camera picture, as before). In Lower third you can put the band Upper, Mid, Lower or a Custom position, and set its background, height, text size, see-through and text colour.",
      ...
      "Your own lower-third title (name / title lines) now shows on your OBS stream: in the band for the Lower third look, and on the Full projector look. On Over your camera it shows as a caption over the camera. It stays up until you send the next slide, or until you clear it.",
