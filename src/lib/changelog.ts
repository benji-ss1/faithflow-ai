...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "Your own lower-third title (name / title lines) now shows on the OBS lower third too, and in the other looks. It stays up until the next slide goes live, or until you clear it.",
