...
//
// NEW RELEASES: do NOT edit this file — add a changes/<slug>.md file (see
// changes/README.md). scripts/build-changelog.mjs turns those into
// changelog.generated.ts on predev/prebuild, merged below with this curated
// history (deduped by version, history wins). Keep highlights operator-facing.

import { mergeChangelog, type ChangelogEntry } from "./changelog-types";
import { GENERATED_CHANGELOG } from "./changelog.generated";

export type { Highlight, ChangelogEntry } from "./changelog-types";
...
export const CHANGELOG: ChangelogEntry[] = mergeChangelog(GENERATED_CHANGELOG, CHANGELOG_HISTORY);
