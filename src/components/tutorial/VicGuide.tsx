...
const STEPS: Step[] = [
  ...
  { target: "smart-folder", title: "Smart folders — a folder that fills itself", body: "Next to the + in your Library list is a star button. A normal folder is one you drag songs into; a SMART folder fills itself from rules you set, like Title contains Christmas, or Date added in the last 30 days. Nothing is moved or copied, so your existing folders are untouched, and it keeps itself up to date as you add songs.", task: "Click the star to open the rule builder and look at the fields — press Cancel, you do not have to create one now.", route: { centerMode: "songs" } },
