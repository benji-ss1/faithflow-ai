            ...
            <Section label={selText ? (isVerseSelected ? "Verse text" : "Reference / translation") : "Selection"}>
              {selText ? (
                <>
                  ...
                  <Row label="Font"><select value={selText.fontFamily ?? "Sora"} onChange={(e) => patchSelected({ fontFamily: e.target.value })} className={btn + " w-full"} style={bstyle}><FontOptions current={selText.fontFamily ?? "Sora"} /></select></Row>
