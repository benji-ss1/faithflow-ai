  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 12% 18%, rgba(155,143,232,0.22), transparent 42%), radial-gradient(circle at 88% 82%, rgba(156,72,27,0.28), transparent 42%)",
        }}
      />
      <div className="relative flex flex-col items-center gap-5">
        <Image
          ...
          style={{
            filter: "drop-shadow(0 12px 34px rgba(156,72,27,0.4))",
        ...
        <div className="text-[24px] font-semibold tracking-[-0.01em]">
          ...
          <span style={{ color: "#9C481B" }}>Flow</span>
        </div>
